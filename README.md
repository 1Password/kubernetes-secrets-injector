...
1. Check that the namespace of your pod has the `op-secret-injection=enabled` label
2. Ensure that the 1Password Secret Injector webhook is running (`op-injector` by default).
